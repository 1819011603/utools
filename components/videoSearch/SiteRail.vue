<template>
  ...
  <div class="flex flex-wrap gap-2">
    <button
      ...
      class="wf-fade-up group relative flex items-center gap-1.5 rounded-lg px-3 py-1.5 text-xs
    ...
    >
      ...
      <span
        ...
        class="shrink-0 min-w-[1.125rem] px-1 py-0.5 rounded-md text-[10px] font-semibold tabular-nums text-center transition-colors"
        :class="s.siteId === modelValue
      ...
      <span
        ...
        class="shrink-0 min-w-[1.125rem] px-1 py-0.5 rounded-md text-[10px] text-center text-gray-400 dark:text-gray-500 bg-gray-100/70 dark:bg-white/5"
      >0</span>
    </button>
  </div>
</template>
